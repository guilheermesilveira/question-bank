...
public class QuestionMapping : IEntityTypeConfiguration<Question>
{
    public void Configure(EntityTypeBuilder<Question> builder)
    {
        ...
        builder.Property(q => q.CreatedAt).ValueGeneratedOnAdd().HasColumnType("DATETIME");
        builder.Property(q => q.UpdatedAt).ValueGeneratedOnAddOrUpdate().HasColumnType("DATETIME");
    }
}